document.addEventListener('DOMContentLoaded', () => {
    ...
    // Set initial states for medium containers
    gsap.set('#medium-group-container > div', { 
      opacity: 0,
      y: 30 // Start below final position for rising effect
    });
    
    // Additional specific setup for text elements
    gsap.set('#medium-group-container > div p', {
      opacity: 0,
    ...
    masterTimeline.to('#medium-group-container > div', {
      opacity: 1,
      y: 0,
      duration: 1.4,
      stagger: 0.2,
    ...
    masterTimeline.to('#medium-group-container > div p', {
      opacity: 1,
      y: 0,
      duration: 1.2,
      stagger: 0.2,
    ...
    const mediumContainers = document.querySelectorAll('#medium-group-container > div');
